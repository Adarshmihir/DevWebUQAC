                ...
                <div class="panel-body">
                    {!! Form::open(['route'=>'register']) !!}
                        ...
                        <div class="form-group{{ $errors->has('cli_mel') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('cli_mel',null,['class' => 'form-control','required'=>'required','autofocus'=>'autofocus']) !!}
                        ...
                        <div class="form-group{{ $errors->has('cli_pseudo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('cli_pseudo',null,['class' => 'form-control','required'=>'required']) !!}
                        ...
                        <div class="form-group{{ $errors->has('cli_civilite') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('cli_civilite',['M.'=>'Monsieur','Mlle'=>'Mademoiselle','Mme'=>'Madame'],old('cli_civilite'),['class' => 'form-control','required'=>'required','placeholder'=>'Choisissez une option']) !!}
                        ...
                        <div class="form-group{{ $errors->has('cli_nom') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('cli_nom',null,['class' => 'form-control','required'=>'required']) !!}
                        ...
                        <div class="form-group{{ $errors->has('cli_prenom') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('cli_prenom',null,['class' => 'form-control','required'=>'required']) !!}
                        ...
                        <div class="form-group{{ $errors->has('cli_telfixe') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('cli_telfixe',null,['class' => 'form-control']) !!}
                        ...
                        <div class="form-group{{ $errors->has('cli_telportable') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('cli_telportable',null,['class' => 'form-control']) !!}
                        ...
                        <div class="form-group{{ $errors->has('cli_motpasse') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::password('cli_motpasse',['class' => 'form-control','required'=>'required']) !!}
                        ...
                        <div class="form-group{{ $errors->has('cli_motpasse_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::password('cli_motpasse_confirmation',['class' => 'form-control','required'=>'required']) !!}
